...
class PopulationTableDemo extends Component {

    render() {
        console.log("HERE populationd")
                                ...
                                {data.map(rows => 
                                    ...
                                    <TableRow key={uuidv4()}>
                                        ...
                                        <TableCell align="center">
                                            {nrow.nationality_population === 0 ? "Not Available" : nrow.nationality_population}
                                        </TableCell>
...
export default PopulationTableDemo
