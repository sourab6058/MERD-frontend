...
class LabourersTableDemo extends Component {

    render() {
        console.log("HERE labour")
            ...
            if (!empty) {
                ...
                return (
                    <TableContainer component={Paper} style={{ width: '50%', margin: '0 auto' }}>
                        ...
                        <TableCell align="right">Labourer Percentage</TableCell>
                            ...
                            <TableBody>
                                ...
                                <TableRow key={uuidv4()}>
                                        ...
                                        <TableCell align="right">
                                            {rows.labourer_percent === 0 ? "Not Available" : rows.labourer_percent+'%'}
                                        </TableCell>
...
export default LabourersTableDemo
