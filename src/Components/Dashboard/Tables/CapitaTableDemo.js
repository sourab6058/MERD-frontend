...
class CapitaTableDemo extends Component {

    render() {
        console.log("HERE capita")
                    ...
                    <TableContainer component={Paper} style={{ width: '95%', margin: '0 auto' }}>
                        ...
                        <TableCell align="right">{row.nationality}</TableCell>
                            ...
                            <TableBody>
                                ...
                                {row.category_data.map((row2)=>
                                     <TableCell align="right">{ `$ ${row2.category_expense}`}</TableCell>
                                )}
...
export default CapitaTableDemo
