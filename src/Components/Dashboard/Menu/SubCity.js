...
export class SubCity extends Component {
    ...
    render() {
        ...
        return (
            ...
            this.props.country.country === "UAE" ?
                <SubMenu key={this.props.city.city} title={this.props.country.country} {...filteredProps}>
                    
                    {
                     optionData[4][1].filter((ct) => ct.country.country === "UAE").map((d, i) => {
                            return (
                                
                                <SubMenu key={this.props.city.country} title={d.city} {...filteredProps}>
                                {/* {console.log(this.props.city.city,"his.props.city.city")} */}
                                <Menu.Item><Checkbox onChange={(e) => this.checkedAll('cities', d.id, e)}>Select All</Checkbox></Menu.Item>
                                {d.zone.map(zone =>
